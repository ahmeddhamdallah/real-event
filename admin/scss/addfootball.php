<?php
  ...
  if (isset($_POST['submit'])){
    ...
    $query = "INSERT INTO football (content,image,title) VALUES ('$content','$image','$title')";
    $run = $db->insert($query);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
         <li class="fh5co"><a href="sportmanager.php">Sport Manage <span class="sr-only">(current)</span></a></li>
