...
if ($_POST['addcategoryname']) {
	...
	$add_content = mysqli_real_escape_string($db_conn, $_POST['add_content']);
	$add_title = mysqli_real_escape_string($db_conn, $_POST['add_title']);
	...
	if ($addcategoryname) {
		foreach ($addcategoryname as $add_categoryname){


		# code...
	

		$insert_category = "insert into sport (category,content,image,title) VALUE ('$add_categoryname','$cat_pid')";
